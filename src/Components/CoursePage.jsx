        ...
        {currentRound !== 1 && (
          <div className="mb-1 mr-2">
            ...
            >
              ...
              <option value="Non-Department Preference 1">
                Non-Department Preference 1
              </option>
              <option value="Non-Department Preference 2">
                Non-Department Preference 2
              </option>
              <option value="Non-Department Preference 3">
                Non-Department Preference 3
              </option>
              <option value="Non-Department Preference 4">
                Non-Department Preference 4
              </option>
              <option value="Non-Department Preference 5">
