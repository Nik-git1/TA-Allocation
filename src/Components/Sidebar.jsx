  ...
  return (
    <div className='bg-[#3dafaa] h-screen text-center max-w-[95%] mt-4'>
      <div className='flex flex-col'>
        <Link to="/admin/" className='bg-[#3dafaa] p-2 h-16 hover:bg-[rgb(50,140,135)] focus:bg-[rgb(50,140,135)] text-white font-bold'>
          Dashboard
        </Link>
        <hr className='border-t-2' />
        <Link to="/admin/student" className='bg-[#3dafaa] h-16 p-2 hover:bg-[rgb(50,140,135)] focus:bg-[rgb(50,140,135)] text-white font-bold'>
          Students
        </Link>
        <hr className='border-t-2' />
        ...
        <hr className='border-t-2' />
        <Link to="/admin/logs" className='bg-[#3dafaa] p-2 h-16 hover:bg-[rgb(50,140,135)] focus:bg-[rgb(50,140,135)] text-white font-bold'>
          Logs
        </Link>
        <hr className='border-t-2' />
